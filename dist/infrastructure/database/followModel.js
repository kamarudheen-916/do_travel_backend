...
const FollowingDataSchema = new mongoose_1.Schema({
    followingID: { type: String },
    follwingDate: { type: Date, default: Date.now() },
    isAccepted: { type: Boolean, default: false },
    isProperty: { type: Boolean }
});
const FollowerDataSchema = new mongoose_1.Schema({
...
const followModel = mongoose_1.default.model('Follower', followSchema);
