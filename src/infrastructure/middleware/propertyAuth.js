...
const PropertyAuth = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        if (decodedToken && decodedToken.id) {
            let user = yield repository.findUserById(decodedToken === null || decodedToken === void 0 ? void 0 : decodedToken.id, decodedToken === null || decodedToken === void 0 ? void 0 : decodedToken.role);
